...
const SingleProductPage = () => {
  ...
  return (
    <div className='py-2 lg:py-20 px-5 lg:px-16 xl:px-28'>
      {/* Navigation */}
        ...
        <div className='flex-1 flex flex-col gap-8 justify-center'>
          ...
          <div className='flex flex-col gap-2'>
            <p className='text-gray-500 text-sm'>
              ...
              temporibus quos incidunt ex voluptatem in perferendis voluptatibus
              molestiae. Eos fugit natus sapiente nam excepturi veniam?
              Accusamus iure dicta tenetur rem pariatur debitis necessitatibus a
              repellat qui dignissimos accusantium veritatis sint, omnis non ab.
              Sequi, voluptate sit exercitationem nemo, accusantium vitae vel
              debitis mollitia minima numquam beatae, vero dolor asperiores
              voluptas quo? Rem blanditiis amet eligendi ipsum asperiores
              debitis animi facilis molestiae, dicta consequuntur recusandae
              voluptatibus! Ab qui in, culpa ratione non, impedit illum
              explicabo odio, ex modi veritatis esse. Saepe totam deserunt
              molestias?
            </p>
